...
export default function OurStars() {
  return (
    <section className="relative py-32 bg-gradient-to-b from-[#eef4ff] via-[#f6f9ff] to-white">
      ...
      {/* Top soft separator glow */}
      <div className="absolute top-0 left-0 w-full h-16 bg-gradient-to-b from-[#dbeafe] to-transparent" />
      ...
      <div className="absolute bottom-0 left-0 w-full h-20 bg-gradient-to-t from-[#eef4ff] to-transparent" />
    </section>
  );
}
